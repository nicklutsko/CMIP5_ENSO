...
Script for binning CMIP5 data by \omega_500 velocities. Assumes the netcdf files are labeled according to their model names. To bin monthly data set k = 1 in the call of w500_bin.annual_binned_data
...
opts = [ "wap", "tas", "rlut", "rsut", "rsutcs", "rlutcs"]
o = len( opts )
lev = 7 #= 500hPa on the CMIP5 grids
...
for z in range( m ):
	...
	print "Bin data"
	binned_dat[z], pdf_wap[z] = w500_bin.annual_binned_data( data, bins, 12 )
...
sdat( binned_dat, "data/AM_binned_data_5hpa.dat" )
sdat( pdf_wap, "data/AM_pdf_wap_5hpa.dat" )
